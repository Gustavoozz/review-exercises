...
class Program
{
    static void Main()
    {
        ...
        List<Aluno> alunos = new List<Aluno>
        {
            ...
            new Aluno("Pedro", "Português", new List<double> { 6.0, 5.5, 6.0 }),
            new Aluno("Maria","Português", new List<double> { 9.0, 8.0, 7.5 }),
            new Aluno("João", "Português", new List<double> { 5.0, 6.0, 5.5 })
        };
